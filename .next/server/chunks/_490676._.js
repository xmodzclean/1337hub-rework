...
"[project]/src/app/api/students/update/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
async function POST(req) {
    ...
    if (!bannerUrl.endsWith(".gif") && !bannerUrl.endsWith(".jpeg") && !bannerUrl.endsWith(".png") && bannerUrl !== "") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    try {
        ...
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.update({
            where: {
                user_name: session.user.login
            },
            data: {
                curr_level: currentLevel,
                last_level: isLevelChanged ? existingUser.curr_level : existingUser.last_level,
                nickname: nickname,
                banner_url: bannerUrl,
                bio: bio ? bio.trim() : existingUser.bio,
                is_verified: true
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=_490676._.js.map