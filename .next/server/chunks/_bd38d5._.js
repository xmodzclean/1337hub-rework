...
"[project]/src/app/api/students/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$get_gender$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/get_gender.ts [app-route] (ecmascript)");
...
async function GET(req) {
    ...
    try {
        const response = await fetch(`https://api.intra.42.fr/v2/cursus_users?&filter[campus_id]=${campus_id}&filter[begin_at]=${started_date}&page[size]=100&page[number]=${page}&sort=-level`, {
            headers: {
        ...
        const DbStudents = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findMany(); // get All Registered students from MongoDB
        // Get All User_names from DbStudents
        const dbStudentsMap = new Map(DbStudents.map((dbUser)=>[
                dbUser.user_name,
                dbUser
            ]));
        const UpdatedStudentsData = ApiStudents.map((user, index)=>{
            ...
            return {
                ...
                Gender: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$get_gender$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGender"])(user.user.first_name.trim()),
                verified: dbStudent?.is_verified || false,
                nickname: dbStudent?.nickname || null,
                banner_url: dbStudent?.banner_url || null,
                bio: dbStudent?.bio || null
            };
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(UpdatedStudentsData, {
            status: 200
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=_bd38d5._.js.map